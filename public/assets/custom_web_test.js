...
$(document).on('click', '.loadBtn', function () {
    ...
    var new_fulllink = baseurl + "ajaxfiles/catalog_filter.php" + newlink + "start=" + page + "&loadmore=call" + abc + order;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.message == "add") {
                ...
                $("#id" + id).html('<i class="fa fa-heart" style="font-size:17px;color:#D97676 !important;"></i>');
            ...
            if (data.message == "remove") {
                ...
                $("#id" + id).html('<i class="fa fa-heart-o" style="font-size:17px;color:#D97676 !important;"></i>');
            }
            countwish();
...
function calculate_grandtotal() {
    ...
    var currency_cost = c_convert;
    var grand_total = parseInt(subtotal) + parseInt(shipping_charge11);
    totalgst = 0;

    fullgrandtot = store_value(grand_total, 'fullgrandtot');
    fullgrandtot = fullgrandtot - +coupon;
    console.log(fullgrandtot, 'jhvvjfsav');
