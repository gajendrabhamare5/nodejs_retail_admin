...
Line 888:56 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 889:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 890:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 895:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 896:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 897:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 900:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 900:58 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 916:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 917:8 Transforming const to the configured target environment ("es5") is not supported yet
