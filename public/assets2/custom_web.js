...
function addtocart(product_id,carttype1) {
    ...
    if ($("fieldset").hasClass("sizeavailable")) {
        if ($(".customeclass_" + product_id).hasClass("active")) {
            ...
            $(".customcartbtn_buy").attr("onclick", "addtocart(" + product_id + ",'buy')");
            ...
            if (data.status == "ok") {
                ...
                if (paymentmethod == "Online Payments" && ordertotal != 0 && redirect_online == 'yes') {
                    ...
                    if (oidnew.length > 0 && oidnew != "0") {
                        ...
                        window.location.href = baseurl + "payment/phonepay/phonepe.php?oid=" + orid;
                    }
                    else {
...
function calculate_grandtotal() {
    ...
    console.log("shipping_charge11=",shipping_charge11);
    console.log("transaction_charge=",transaction_charge);
    console.log("handling_chrg=",handling_chrg);
    ...
    console.log("fullgrandtot=",fullgrandtot);
    console.log("fullgrandtot=",currency_cost);
